export const translations = {
  en: {
    ...
    brand: {
      ...
      contentNotice:
        "EP Chemical provides practical cleaning and care solutions for homes and cars, with products designed to make daily use easier and more reliable.",
      aboutText:
    ...
    home: {
      ...
      bestTitle: "Popular EP Chemical products",
      ...
      socialTitle: "Stay close to EP Chemical",
      socialText:
        "Follow updates, product care tips, and upcoming offers from EP Chemical.",
      socialCta: "Follow us",
    },
    products: {
      eyebrow: "Products",
      title: "EP Chemical product catalog",
    ...
    cart: {
      ...
      emptyText: "Start browsing EP Chemical products and add the items that fit your needs.",
    ...
    auth: {
      ...
      loginPageText:
        "Log in to your EP Chemical account to continue shopping, review orders, and complete purchases securely.",
      registerPageText:
        "Create your EP Chemical account to track orders and complete future purchases faster.",
    ...
    footer: {
      ...
      description: "EP Chemical provides practical cleaning and care solutions for homes and cars, with products designed to make daily use easier and improve the cleaning experience.",
      shop: "Shop",
      products: "Products",
      account: "Account",
      contact: "Contact us",
    ...
    whatsapp: {
      intro: "Hello EP Chemical, I would like to place this order:",
      customer: "Customer",
      phone: "Phone",
      city: "City / Area",
      address: "Address",
  ...
  ar: {
    ...
    brand: {
      ...
      aboutText:
        "EP Chemical تقدم حلول تنظيف وعناية عملية للمنزل والسيارة والأثاث والأرضيات والمعطرات وماء الرديتر، بمنتجات مصممة للاستخدام اليومي ونتائج واضحة وتجربة تسوق سهلة.",
    },
    home: {
      ...
      socialText:
        "اشترك ليصلك جديد منتجات EP Chemical والعروض الخاصة أولًا بأول.",
      socialCta: "اشترك الآن",
    },
    products: {
      eyebrow: "المنتجات",
      title: "كتالوج منتجات EP Chemical",
    ...
    cart: {
      ...
      emptyText: "ابدأ بتصفح منتجات EP Chemical وأضف المنتجات التي تناسب احتياجك.",
    ...
    auth: {
      ...
      loginPageText:
        "سجّل الدخول إلى حسابك في EP Chemical لمتابعة التسوق، مراجعة طلباتك، وإتمام الشراء بأمان.",
      registerPageText:
        "أنشئ حسابك في EP Chemical لتتبع الطلبات وإتمام عمليات الشراء القادمة بسرعة أكبر.",
    ...
    footer: {
      ...
      description: "EP Chemical تقدم حلول تنظيف وعناية عملية للمنزل والسيارة، بمنتجات مصممة لتسهيل الاستخدام اليومي وتحسين تجربة النظافة والعناية.",
      shop: "المتجر",
      products: "المنتجات",
      account: "حسابي",
      contact: "تواصل معنا",
